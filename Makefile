...
libssh:
	cd ./3rd/libssh/ && rm -rf build && mkdir build && cd build && cmake ../ -DCMAKE_INSTALL_PREFIX=../../build && make install && cp -r ../include/ ../../build/include && cp config.h ../../build/include/libssh
